...
<head>
    ...
    <link rel="stylesheet" href="{{asset('polished-template/demo/polished.min.css')}}">
    <link rel="stylesheet" href="{{asset('polished-template/dist/iconic/css/open-iconic-bootstrap.min.css')}}">
...
<body>
    ...
    <nav class="navbar navbar-expand p-0">
        ...
        <input class="border-dark bg-primary-darkest form-control d-none d-md-block w-50 ml-3 mr-2" type="text" placeholder="Search" arial-label="Search">
        ...
        <div style="min-height:  100%" class="flex-row d-flex align-items-stretch m-0">
            <div class="polished-sidebar bg-light  col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline"               id="sidebar-nav">
                ...
                <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
                    ...
                    <li>
                        <a href="{{route('users.index')}}"> <span class="oi oi-people"></span>Manage User</a>
                    </li>
                    <li>
    ...
    <script
        src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.0/umd/popper.min.js" integrity="sha384-cschFZiN24E4KMATLdqdvsezGxaGsi4hLGOzlXwp5UZB1LY//20VyM2taTB4QvJ"
