...
class BookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->get('save_action')  == 'PUBLISH') {
            return redirect()->route('books.index')->with('status', 'Book successfuly saved and publish');
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('books.index', [$book->id])->with('status', 'Book Succesfuly updated');
    }
    ...
    public function restore($id)
    {
        ...
        if ($book->trashed()) {
            ...
            return redirect()->route('books.trash')->with('status', 'Book successfuly restored');
        } else {
