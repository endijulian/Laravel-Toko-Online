...
class CategoryController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // return redirect()->route('categories.edit', [$id])->with('status', 'Category Successfuly Updated');
        return redirect()->route('categories.index', [$id])->with('status', 'Category Successfuly Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('categories.index')->with('sukses', 'Category Susscessfuly Move to Trash');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('categories.index')->with('sukses', 'Category succes restored');
    }
    ...
    public function deletePermanent($id)
    {
        ...
        if (!$category->trashed()) {
            return redirect()->route('categories.index')->with('status', 'Can not deleted permanent active category');
        } else {
